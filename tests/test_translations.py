...
class TestTranslations(unittest.TestCase):
    ...
    def test_pl_validation_translation(self):
        xml_path = "tests//test_cases//examples//polish_translation//tytul_wykonawczy_niekompletny.xml"
        xsd_path = "tests//test_cases//examples//polish_translation//tw-1(5)8e.xsd"
        expected_errors = [
