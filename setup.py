...
setup(
    ...
    python_requires='>=3.9',
    install_requires=['elementpath>=4.8.0, <6.0.0'],
    extras_require={
        'codegen': ['elementpath>=4.8.0, <6.0.0', 'jinja2'],
        'dev': ['tox', 'coverage', 'lxml', 'elementpath>=4.8.0, <6.0.0',
                'memory_profiler', 'Sphinx', 'sphinx_rtd_theme', 'jinja2',
                'flake8', 'mypy', 'lxml-stubs'],
        'docs': ['elementpath>=4.8.0, <6.0.0', 'Sphinx', 'sphinx_rtd_theme', 'jinja2']
    },
