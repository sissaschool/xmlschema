...
from sdcvalidator.exceptions import XMLSchemaValueError, XMLSchemaTypeError
from sdcvalidator.aliases import SchemaType
from sdcvalidator.names import XSD_NAMESPACE

if TYPE_CHECKING:
    from sdcvalidator.core import XsdElement, XsdAnyElement, XsdAssert
...
class XMLSchemaProxy(AbstractSchemaProxy):
    ...
    def __init__(self, schema: Optional[SchemaType] = None,
        ...
        if schema is None:
            from sdcvalidator import XMLSchema10
