...
from sdcvalidator.aliases import NsmapType, NormalizedLocationsType, \
    LocationsType, XMLSourceType, UriMapperType
from sdcvalidator.exceptions import XMLResourceError, XMLResourceOSError, XMLSchemaValueError
