...
class XsdAtomic(XsdSimpleType):
    ...
    def __repr__(self) -> str:
        if self.name is None:
            return '{}(primitive_type={!r})'.format(
...
class XsdList(XsdSimpleType):
    ...
    def __repr__(self) -> str:
        if self.name is None:
            return '{}(item_type={!r})'.format(self.__class__.__name__, self.item_type)
        else:
            return '{}(name={!r})'.format(self.__class__.__name__, self.prefixed_name)
...
class XsdUnion(XsdSimpleType):
    ...
    def __repr__(self) -> str:
        if self.name is None:
            return '{}(member_types={!r})'.format(self.__class__.__name__, self.member_types)
        else:
            return '{}(name={!r})'.format(self.__class__.__name__, self.prefixed_name)
